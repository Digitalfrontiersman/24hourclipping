...
Reference material for 24 Hour Clipping. (Code lives in `backend/` and `frontend/`.)

| File | What it is |
|---|---|
| [DEPLOY.md](DEPLOY.md) | How to deploy the Docker stack to a VPS + attach a domain with HTTPS |
| [SERVER-ACCESS.md](SERVER-ACCESS.md) | How to reach the live server (WireGuard tunnel + SSH) and common ops |
